...
const CreateInternshipPost = ({
  ...
  useEffect(() => {
    if (!facultyId) {
      setError("Faculty ID is mandatory.");
    }
  }, [facultyId]);
  ...
  const onCreatePost = async (values) => {
    try {
      const selectedCompanyId = companyId ? companyId : values.company;
      ...
      form.resetFields();
      router.push(onFinishUrl || "/students/internships");
  ...
  return (
    <div className="font-default text-dark-blue">
      <div className="flex justify-center mt-4">
        <div className="!w-7/12 shadow p-6 bg-white rounded">
          <Form
            form={form}
            layout="vertical"
            labelCol={{ span: 24 }}
            ...
            <Row gutter={16}>
              <Col span={12}>
                <Form.Item
                  ...
                  name="title"
                  rules={[
                    { required: true, message: "Please input a job title!" },
                  ]}
                >
                  <Input
              ...
              <Col span={12}>
                ...
                >
                  <Select
                    ...
                    value={companyName || companySearchTerm}
                    size="large"
                    onSelect={(value, option) =>
                      setCompanySearchTerm(option.children)
                    }
            ...
            <Row gutter={16}>
              ...
              <Col span={12}>
                <Form.Item
                  ...
                  name="location"
                  rules={[
                    { required: true, message: "Please input a job location!" },
                  ]}
                >
                  <Input
                    className="font-default font-normal text-dark-dark-blue"
